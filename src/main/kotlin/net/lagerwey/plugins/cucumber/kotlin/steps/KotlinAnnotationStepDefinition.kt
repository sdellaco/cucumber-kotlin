...
class KotlinAnnotationStepDefinition(private val annotationEntry: KtAnnotationEntry) :
    AbstractStepDefinition(annotationEntry) {
    companion object {
    ...
    private fun getStepDefinitionText(): String? {
        val annotationEntry = element as? KtAnnotationEntry
        val argument = annotationEntry?.valueArguments?.getOrNull(0)?.getArgumentExpression() ?: return null
